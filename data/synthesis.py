...
from core.preprocess.slicing import get_slice_from_flow
...
from utils.utils import slilce_check_syntax
...
def collect_synthesis_samples(systhesis_sample_lists, synthesis_save_path, CWE):
    ...
    for step, json_data in enumerate(tqdm(systhesis_sample_lists)):
        # if step % 50 == 0:
        #     print("[INFO] now json " + clear_target_directory.split('\\')[-1] + "\t step: {}".format(str(step)))
        #
        ...
        #     sample_file_name = json_file.split('_')[1] + '_' + json_file.split('_')[2] + '_' + json_file.split('_')[
        #         3] + '.php'
        #
        #     # find origin sample
        ...
        # json_file_path = clear_target_directory + '\\' + json_file
